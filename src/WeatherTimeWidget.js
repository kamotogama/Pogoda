...
const translations = {
  ...
  es: {
    ...
    cities: {
      ...
      CN: ['Shanghái', 'Pekín', 'Guangzhou', 'Shenzhen', 'Chengdu', 'Nanjing', 'Wuhan', 'Xi'an', 'Hangzhou', 'Chongqing'],
  ...
  cities: {
    ...
    CN: ['Shanghai', 'Peking', 'Guangzhou', 'Shenzhen', 'Chengdu', 'Nanjing', 'Wuhan', 'Xi'an', 'Hangzhou', 'Chongqing'],
    IN: ['Mumbai', 'Delhi', 'Bangalore', 'Hyderabad', 'Ahmedabad', 'Chennai', 'Kolkata', 'Surat', 'Pune', 'Jaipur'],
    BR: ['São Paulo', 'Rio de Janeiro', 'Salvador', 'Brasília', 'Fortaleza', 'Belo Horizonte', 'Manaus', 'Curitiba', 'Recife', 'Porto Alegre'],
	...
	fr: {
	  ...
	  cities: {
		...
		CN: ['Shanghai', 'Pékin', 'Guangzhou', 'Shenzhen', 'Chengdu', 'Nanjing', 'Wuhan', 'Xi'an', 'Hangzhou', 'Chongqing'],
  ...
  it: {
    ...
    cities: {
      ...
      CN: ['Shanghai', 'Pechino', 'Guangzhou', 'Shenzhen', 'Chengdu', 'Nanchino', 'Wuhan', 'Xi'an', 'Hangzhou', 'Chongqing'],
      IN: ['Mumbai', 'Delhi', 'Bangalore', 'Hyderabad', 'Ahmedabad', 'Chennai', 'Calcutta', 'Surat', 'Pune', 'Jaipur'],
  ...
  return (
    <div className={`relative overflow-hidden shadow-lg text-white flex flex-col items-center justify-between transition-all duration-1000 ease-in-out w-full h-full min-h-screen ${getBackgroundClass()}`}>
      ...
      <div className="flex flex-col items-center z-10 my-8">
        <WeatherIcon />
        <div className="text-[5vmin] capitalize font-light mt-4 text-center">
          {weather.condition}
        </div>
        ...
        <div className="mt-4 flex items-center text-[3.5vmin]">
